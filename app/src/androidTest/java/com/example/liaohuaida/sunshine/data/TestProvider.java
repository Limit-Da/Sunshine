...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        // content://com.example.liaohuaida.sunshine/weather/
        String type = mContext.getContentResolver().getType(WeatherContract.WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.liaohuaida.sunshine/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherContract.WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.example.liaohuaida.sunshine/weather/94074
        ...
        // vnd.android.cursor.item/com.example.liaohuaida.sunshine/weather/1419120000
    ...
    public void testBasicWeatherQuery() {
        ...
        ContentValues testValues = TestUtilities.createXiAnLocationValues();
        long locationRowId = TestUtilities.insertXiAnLocationValues(mContext);
    ...
    public void testUpdateLocation() {
        ...
        ContentValues values = TestUtilities.createXiAnLocationValues();
